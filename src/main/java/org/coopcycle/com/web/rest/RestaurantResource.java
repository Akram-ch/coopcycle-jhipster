...
/**
 * REST controller for managing {@link org.coopcycle.com.domain.Restaurant}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Restaurant> partialUpdateRestaurant(
        ...
        Optional<Restaurant> result = restaurantRepository
            ...
            .map(existingRestaurant -> {
                if (restaurant.getRestId() != null) {
                    existingRestaurant.setRestId(restaurant.getRestId());
                }
                if (restaurant.getName() != null) {
                    existingRestaurant.setName(restaurant.getName());
                }
                if (restaurant.getAdress() != null) {
                    existingRestaurant.setAdress(restaurant.getAdress());
                }
                if (restaurant.getTheme() != null) {
                    existingRestaurant.setTheme(restaurant.getTheme());
                }
                if (restaurant.getReview() != null) {
                    existingRestaurant.setReview(restaurant.getReview());
                }
