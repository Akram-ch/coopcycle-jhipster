...
type ClientFormGroupContent = {
  ...
  clientName: FormControl<IClient['clientName']>;
  clientRegion: FormControl<IClient['clientRegion']>;
  panier: FormControl<IClient['panier']>;
  cooperative: FormControl<IClient['cooperative']>;
};
...
export class ClientFormService {
  createClientFormGroup(client: ClientFormGroupInput = { id: null }): ClientFormGroup {
    ...
    return new FormGroup<ClientFormGroupContent>({
      ...
      clientName: new FormControl(clientRawValue.clientName, {
        validators: [Validators.required],
      }),
      clientRegion: new FormControl(clientRawValue.clientRegion),
      panier: new FormControl(clientRawValue.panier),
      cooperative: new FormControl(clientRawValue.cooperative),
    });
  }
